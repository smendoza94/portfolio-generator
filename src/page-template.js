...
const generateProjects = projectsArr => {
    return `
        <section class="my-3" id="portfolio">
            ...
            ${projectsArr.fliter(({feature}) => feature)
...
//         `;
//     });
//     // // code if all values were the same, all were non featured and uniform.
...
module.exports = templateData => {
    ...
    // deconstruction project and about data from TemplateData based on their property key name
